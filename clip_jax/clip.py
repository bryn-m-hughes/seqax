...
def normalize(image):
    ...
    image = (image - mean_reshaped) / std_reshaped  # Normalize
    return image
...
def preprocess_images(images):
    preprocess_fn = vmap(lambda img: preprocess_image(img))
